<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:97:"D:\wamp\www\yikesong\public/../application/useradmin\view\specialservice\companycontent_edit.html";i:1536991448;s:64:"D:\wamp\www\yikesong\application\useradmin\view\common\base.html";i:1536804058;s:64:"D:\wamp\www\yikesong\application\useradmin\view\common\meta.html";i:1536804058;s:66:"D:\wamp\www\yikesong\application\useradmin\view\common\footer.html";i:1536804057;}*/ ?>
<!--引入meta模板-->
<!DOCTYPE HTML>
<html>
<head>
...
<!--模板继承 业务内容-->
    ...
    <title>
        <?php if($option == 'add'): ?>添加<?php else: ?>编辑<?php endif; ?>公司内容
    </title>
    ...
    <div class="page-container">
        <form class="form form-horizontal" id="form-article-add" action="<?php echo url('specialservice/companycontent_edit'); ?>" method="post">
            <div class="row cl">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" value="<?php echo !empty($list['found_time'])?$list['found_time']: ''; ?>" placeholder="" id="" name="found_time">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2">公司位置：</label>
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" value="<?php echo !empty($list['location'])?$list['location']: ''; ?>" placeholder="" id="" name="location">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2">资质情况：</label>
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" value="<?php echo !empty($list['aptitude'])?$list['aptitude']: ''; ?>" placeholder="" id="" name="aptitude">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2">记账情况：</label>
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" value="<?php echo !empty($list['tally'])?$list['tally']: ''; ?>" placeholder="" id="" name="tally">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2">名下固产：</label>
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" value="<?php echo !empty($list['solid_assets'])?$list['solid_assets']: ''; ?>" placeholder="" id="" name="solid_assets">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2">注册资金：</label>
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" value="<?php echo !empty($list['regmoney'])?$list['regmoney']: ''; ?>" placeholder="" id="" name="regmoney">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2">备注：</label>
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" value="<?php echo !empty($list['remark'])?$list['remark']: ''; ?>" placeholder="" id="" name="remark">
                </div>
            </div>
            <div class="row cl">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9" id="div_picture">
                    ...
                    <?php if(empty($list['picture'])): ?>
                        <img src="/yikesong/public/static/h-ui.admin/images/default-thumbnail.png" id="thumb-preview" width="50" style="cursor: hand"/>
...
<!--模板继承 业务相关的脚本-->
    ...
    <script type="text/javascript">
        ...
        $(function(){
            var filter = '<?php echo $list['filter_id']; ?>';
            filter=JSON.parse(filter);
            console.log(filter);
            $.each(filter,function(key,val){
                $("#filter_id option[value="+val+"]").attr("selected",true);
            })
        });
        $(function(){
        ...
        (function( $ ){
            ...
            $(function() {
                ...
                uploader = WebUploader.create({
                    ...
                    dnd: '#dndArea',
                    paste: '#uploader',
                    swf: '/yikesong/public/lib/webuploader/0.1.5/Uploader.swf',
                    chunked: false,
                    chunkSize: 512 * 1024,
                    ...
                    if ( file.getStatus() === 'invalid' ) {
                        ...
                        uploader.makeThumb( file, function( error, src ) {
                            ...
                            if( isSupportBase64 ) {
                                ...
                                $.ajax('/yikesong/public/lib/webuploader/0.1.5/server/preview.php', {
                                    method: 'POST',
                                    data: src,
                                    dataType:'json'
                ...
                uploader.on( 'uploadSuccess', function( file,response) {
                    ...
                    //显示缩略图
                    $('#div_picture').prepend("<img src='/yikesong/public/uploads/images/"+response._raw+"' width='100' style='cursor: hand' />");
