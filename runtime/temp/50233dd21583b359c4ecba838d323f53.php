<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:95:"/data/wwwroot/app.yikesong66.com/public/../application/useradmin/view/member/member_coupon.html";i:1536647332;s:76:"/data/wwwroot/app.yikesong66.com/application/useradmin/view/common/base.html";i:1536647331;s:76:"/data/wwwroot/app.yikesong66.com/application/useradmin/view/common/meta.html";i:1536647331;s:78:"/data/wwwroot/app.yikesong66.com/application/useradmin/view/common/footer.html";i:1536647331;}*/ ?>
<!--引入meta模板-->
<!DOCTYPE HTML>
<html>
<head>
...
<!--模板继承 业务内容-->
    ...
    <body>
    <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 用户管理 <span class="c-gray en">&gt;</span> 用户优惠券列表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
            ...
            <div class="mt-20">
                <table class="table table-border table-bordered table-bg table-hover table-sort">
                    ...
                    <tr class="text-c">
                        ...
                        <th width="100">状态</th>
                        <th width="50">抵扣价格</th>
                        <th width="100">满价可用</th>
                        <th width="100">使用时间</th>
                        <th width="100">使用期限</th>
                    </tr>
                    </thead>
                    <tbody>
                    <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?>
                        <tr class="text-c">
                            ...
                            <td class="td-status">
                                <span class="label <?php echo $vo['status_show']=='未使用'?'label-success' : 'label-defaunt'; ?> radius"><?php echo $vo['status_show']; ?></span>
                            </td>
