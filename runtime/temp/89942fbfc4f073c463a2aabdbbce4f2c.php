<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:89:"/data/wwwroot/app.yikesong66.com/public/../application/useradmin/view/content/demand.html";i:1536741708;s:76:"/data/wwwroot/app.yikesong66.com/application/useradmin/view/common/base.html";i:1536741707;s:76:"/data/wwwroot/app.yikesong66.com/application/useradmin/view/common/meta.html";i:1536741707;s:78:"/data/wwwroot/app.yikesong66.com/application/useradmin/view/common/footer.html";i:1536741707;}*/ ?>
<!--引入meta模板-->
<!DOCTYPE HTML>
<html>
<head>
...
<!--模板继承 业务内容-->
    ...
    <div class="page-container">
        ...
        <form class="form form-horizontal" action="<?php echo url('content/demand'); ?>" method="post">
                ...
                <table class="table table-border table-bordered table-bg table-hover table-sort">
                    ...
                    <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                        <tr class="text-c">
                            ...
                            <td><?php echo $vo['member']['nickname']; ?></td>
                            <td><?php echo $vo['content']; ?></td>
                            <td><?php echo $vo['create_time']; ?></td>
                            <td class="td-manage">
                                <!--<a style="text-decoration:none" class="ml-5" href="<?php echo url('content/demand_edit',['id'=>$vo['id'],'option'=>'update']); ?>" title="编辑"><i class="Hui-iconfont" style="font-size:20px;">&#xe6df;</i></a>-->
    ...
    <script type="text/javascript">
        ...
        function picture_stop(obj,id,show){
            layer.confirm('确认要下架吗？',function(index){
                $.ajax({
                    type: 'POST',
                    url: "<?php echo url('content/integral_show'); ?>",
        ...
        function picture_del(obj,id){
            layer.confirm('确认要删除吗？',function(index){
                $.ajax({
                    type: 'POST',
                    url: "<?php echo url('content/demand_delete'); ?>",
                    data:{id:id},
                    dataType: 'json',
                    success: function(data){
                        if(data.msg == 'success') {
        ...
        function picture_batch_del(){
            layer.confirm('确认要批量删除吗？',function(index){
                ...
                $.ajax({
                    type: 'POST',
                    url: "<?php echo url('content/demand_batch_delete'); ?>",
