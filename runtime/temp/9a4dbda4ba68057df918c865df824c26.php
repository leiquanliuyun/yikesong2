<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:102:"/data/wwwroot/app.yikesong66.com/public/../application/useradmin/view/specialservice/housecontent.html";i:1536741711;s:76:"/data/wwwroot/app.yikesong66.com/application/useradmin/view/common/base.html";i:1536741707;s:76:"/data/wwwroot/app.yikesong66.com/application/useradmin/view/common/meta.html";i:1536741707;s:78:"/data/wwwroot/app.yikesong66.com/application/useradmin/view/common/footer.html";i:1536741707;}*/ ?>
<!--引入meta模板-->
<!DOCTYPE HTML>
<html>
<head>
...
<!--模板继承 业务内容-->
    ...
    <title>园区服务内容列表</title>
    <!-- 放大图片插件 -->
    <link href="/lib/lightbox2/2.8.1/css/lightbox.css" rel="stylesheet" type="text/css">
    </head>
    <body>
    <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 园区服务内容管理 <span class="c-gray en">&gt;</span> 园区服务内容列表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
    <div class="page-container">
        ...
        <form class="form form-horizontal" action="<?php echo url('specialservice/housecontent_sort'); ?>" method="post">

            <div class="cl pd-5 bg-1 bk-gray mt-20">
		<span class="l">
			<a href="javascript:;" onclick="picture_batch_del()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a>
			<a class="btn btn-primary radius" href="<?php echo url('specialservice/housecontent_edit','option=add'); ?>"><i class="Hui-iconfont">&#xe600;</i> 添加服务</a>
                ...
                <table class="table table-border table-bordered table-bg table-hover table-sort">
                    ...
                    <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                        <tr class="text-c">
                            ...
                            <td><?php echo $vo['housetype']; ?></td>
                            <td><?php echo $vo['filter']['condition']; ?></td>
                            <td><?php echo $vo['name']; ?></td>
                            <td><?php echo $vo['type']; ?></td>
                            <td><?php echo $vo['size']; ?></td>
                            <td><?php echo $vo['orientation']; ?></td>
                            <td><?php echo $vo['floor']; ?></td>
                            <td><?php echo $vo['fixture']; ?></td>
                            <td><?php echo $vo['rental_method']; ?></td>
                            <td><?php echo $vo['price']; ?></td>
                            <td><?php echo $vo['create_time']; ?></td>
                            <td class="td-manage">

                                <a style="text-decoration:none" class="ml-5" href="<?php echo url('specialservice/housecontent_edit',['id'=>$vo['content_id'],'option'=>'update']); ?>" title="编辑"><i class="Hui-iconfont" style="font-size:20px;">&#xe6df;</i></a>
    ...
    <script type="text/javascript">
        ...
        function picture_stop(obj,id,show){
            layer.confirm('确认要下架吗？',function(index){
                $.ajax({
                    type: 'POST',
                    url: "<?php echo url('specialservice/housecontent_show'); ?>",
        ...
        function picture_del(obj,id){
            layer.confirm('确认要删除吗？',function(index){
                $.ajax({
                    type: 'POST',
                    url: "<?php echo url('specialservice/housecontent_delete'); ?>",
                    data:{id:id},
                    dataType: 'json',
                    success: function(data){
                        if(data.msg == 'success') {
        ...
        function picture_batch_del(){
            layer.confirm('确认要批量删除吗？',function(index){
                ...
                $.ajax({
                    type: 'POST',
                    url: "<?php echo url('specialservice/housecontent_batch_delete'); ?>",
