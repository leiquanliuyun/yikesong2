<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:88:"/data/wwwroot/app.yikesong66.com/public/../application/useradmin/view/service/index.html";i:1536741711;s:76:"/data/wwwroot/app.yikesong66.com/application/useradmin/view/common/base.html";i:1536741707;s:76:"/data/wwwroot/app.yikesong66.com/application/useradmin/view/common/meta.html";i:1536741707;s:78:"/data/wwwroot/app.yikesong66.com/application/useradmin/view/common/footer.html";i:1536741707;}*/ ?>
<!--引入meta模板-->
<!DOCTYPE HTML>
<html>
<head>
...
<!--模板继承 业务内容-->
    ...
    <div class="page-container">
        ...
        <form class="form form-horizontal" action="<?php echo url('service/servicecontent_sort'); ?>" method="post">

            <div class="cl pd-5 bg-1 bk-gray mt-20">
		<span class="l">
			<a href="javascript:;" onclick="picture_batch_del()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a>
			<a class="btn btn-primary radius" href="<?php echo url('service/servicecontent_edit','option=add'); ?>"><i class="Hui-iconfont">&#xe600;</i> 添加服务</a>
                        ...
                        <tr class="text-c">
                            ...
                            <td>
                                <?php if(is_array($vo['picture_show']) || $vo['picture_show'] instanceof \think\Collection || $vo['picture_show'] instanceof \think\Paginator): $i = 0; $__LIST__ = $vo['picture_show'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$img): $mod = ($i % 2 );++$i;?>
                                    <div class="picbox"><a href="<?php echo $img; ?>" data-lightbox="gallery" data-title="<?php echo $vo['service']; ?>" style="float:left">
                                        <img width="50" class="picture-thumb" src="<?php echo $img; ?>" title="单击放大"></a></div>
                                <?php endforeach; endif; else: echo "" ;endif; ?>
                            </td>
                            <td><?php echo $vo['introduce_mess']; ?></td>
                            ...
                            <td class="td-manage">
                                ...
                                <a style="text-decoration:none" class="ml-5" href="<?php echo url('service/servicecontent_edit',['id'=>$vo['content_id'],'option'=>'update']); ?>" title="编辑"><i class="Hui-iconfont" style="font-size:20px;">&#xe6df;</i></a>
    ...
    <script type="text/javascript">
        ...
        function picture_stop(obj,id,show){
            layer.confirm('确认要下架吗？',function(index){
                $.ajax({
                    type: 'POST',
                    url: "<?php echo url('service/servicecontent_show'); ?>",
        ...
        function picture_del(obj,id){
            layer.confirm('确认要删除吗？',function(index){
                $.ajax({
                    type: 'POST',
                    url: "<?php echo url('service/servicecontent_delete'); ?>",
                    data:{id:id},
                    dataType: 'json',
                    success: function(data){
                        if(data.msg == 'success') {
        ...
        function picture_batch_del(){
            layer.confirm('确认要批量删除吗？',function(index){
                ...
                $.ajax({
                    type: 'POST',
                    url: "<?php echo url('service/servicecontent_batch_delete'); ?>",
