<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:75:"D:\wamp\www\yikesong\public/../application/useradmin\view\content\news.html";i:1536804057;s:64:"D:\wamp\www\yikesong\application\useradmin\view\common\base.html";i:1536804058;s:64:"D:\wamp\www\yikesong\application\useradmin\view\common\meta.html";i:1536804058;s:66:"D:\wamp\www\yikesong\application\useradmin\view\common\footer.html";i:1536804057;}*/ ?>
<!--引入meta模板-->
<!DOCTYPE HTML>
<html>
<head>
...
<!--模板继承 业务内容-->
    ...
    <div class="page-container">
        <!--<div class="text-c">
            <form class="form form-horizontal" action="<?php echo url('content/news'); ?>" method="post">
        ...
        <form class="form form-horizontal" action="<?php echo url('news/news_sort'); ?>" method="post">

            <div class="cl pd-5 bg-1 bk-gray mt-20">
                <span class="l">
                    <a href="javascript:;" onclick="picture_batch_del()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a>
                    <a class="btn btn-primary radius" href="<?php echo url('content/news_edit','option=add'); ?>"><i class="Hui-iconfont">&#xe600;</i> 添加资讯</a>
            ...
            <div class="mt-20">
                <table class="table table-border table-bordered table-bg table-hover table-sort">
                    ...
                    <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                        <tr class="text-c">
                            <td><input name="check" type="checkbox" value="<?php echo $vo['news_id']; ?>"></td>
                            ...
                            <td class="td-manage">
                                <?php if($vo['status'] == '发布'): ?>
                                    <a style="text-decoration:none" onClick="picture_stop(this,'<?php echo $vo['news_id']; ?>',2)" href="javascript:;" title="下架"><i class="Hui-iconfont" style="font-size:20px;">&#xe6de;</i></a>
                                    <?php else: ?>
                                    <a style="text-decoration:none" onClick="picture_start(this,'<?php echo $vo['news_id']; ?>',1)" href="javascript:;" title="发布"><i class="Hui-iconfont" style="font-size:20px;">&#xe603;</i></a>
                                <?php endif; ?>
                                <a style="text-decoration:none" class="ml-5" href="<?php echo url('content/news_edit',['id'=>$vo['news_id'],'option'=>'update']); ?>" title="编辑"><i class="Hui-iconfont" style="font-size:20px;">&#xe6df;</i></a>
                                <a style="text-decoration:none" class="ml-5" onClick="picture_del(this,'<?php echo $vo['news_id']; ?>')" href="javascript:;" title="删除"><i class="Hui-iconfont" style="font-size:20px;">&#xe6e2;</i></a>
                            </td>
                            <input type="hidden" name="id_array[]" value="<?php echo $vo['news_id']; ?>"/>
                        </tr>
    ...
    <script type="text/javascript">
        ...
        function picture_stop(obj,id,show){
            layer.confirm('确认要下架吗？',function(index){
                $.ajax({
                    type: 'POST',
                    url: "<?php echo url('news/news_show'); ?>",
        ...
        function picture_del(obj,id){
            layer.confirm('确认要删除吗？',function(index){
                $.ajax({
                    type: 'POST',
                    url: "<?php echo url('news/news_delete'); ?>",
                    data:{id:id},
                    dataType: 'json',
                    success: function(data){
                        if(data.msg == 'success') {
        ...
        function picture_batch_del(){
            layer.confirm('确认要批量删除吗？',function(index){
                ...
                if (check_value.length===0){
                    layer.msg('请先选择要删除的资讯!',{icon:2,time:1000});
                }
                $.ajax({
                    type: 'POST',
