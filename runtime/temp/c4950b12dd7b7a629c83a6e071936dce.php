<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:80:"D:\wamp\www\yikesong\public/../application/useradmin\view\content\news_edit.html";i:1536828529;s:64:"D:\wamp\www\yikesong\application\useradmin\view\common\base.html";i:1536804058;s:64:"D:\wamp\www\yikesong\application\useradmin\view\common\meta.html";i:1536804058;s:66:"D:\wamp\www\yikesong\application\useradmin\view\common\footer.html";i:1536804057;}*/ ?>
<!--引入meta模板-->
<!DOCTYPE HTML>
<html>
<head>
...
<!--模板继承 业务内容-->
    ...
    <title>
        <?php if($option == 'add'): ?>添加<?php else: ?>编辑<?php endif; ?>资讯
    </title>
    <link href="/yikesong/public/lib/webuploader/0.1.5/webuploader.css" rel="stylesheet" type="text/css" />
    </head>
    <body>
    <div class="page-container">
        <form class="form form-horizontal" id="form-article-add" action="<?php echo url('content/news_edit'); ?>" method="post">
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2">资讯标题：</label>
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" value="<?php echo !empty($list['title'])?$list['title']: ''; ?>" placeholder="" id="" name="title">
                </div>
            </div>
            ...
            <div class="row cl">
				...
				<select name="show" class="select">
					<option value="1" <?php echo $list['status']=='发布'?'selected': ''; ?>>发布</option>
                    <option value="2" <?php echo $list['status']=='下架'?'selected' : ''; ?>>下架</option>
				</select>
				</span>
                </div>
            </div>
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" value="<?php echo !empty($list['sort'])?$list['sort'] : 0; ?>" placeholder="从大到小排序" id="" name="sort">
                </div>
            </div>
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <script id="editor" type="text/plain" style="width:100%;height:400px;"><?php echo !empty($list['content'])?$list['content']: ''; ?></script>
                </div>
            </div>
            <div class="row cl">
