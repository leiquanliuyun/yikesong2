<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:104:"/data/wwwroot/app.yikesong66.com/public/../application/useradmin/view/specialservice/companycontent.html";i:1536720771;s:76:"/data/wwwroot/app.yikesong66.com/application/useradmin/view/common/base.html";i:1536720770;s:76:"/data/wwwroot/app.yikesong66.com/application/useradmin/view/common/meta.html";i:1536720770;s:78:"/data/wwwroot/app.yikesong66.com/application/useradmin/view/common/footer.html";i:1536720770;}*/ ?>
<!--引入meta模板-->
<!DOCTYPE HTML>
<html>
<head>
...
<!--模板继承 业务内容-->
    ...
    <title>资质转让内容列表</title>
    <!-- 放大图片插件 -->
    <link href="/lib/lightbox2/2.8.1/css/lightbox.css" rel="stylesheet" type="text/css">
    </head>
    <body>
    <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 资质转让内容管理 <span class="c-gray en">&gt;</span> 资质转让内容列表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
    <div class="page-container">
        <!--<div class="text-c">
            <form class="form form-horizontal" action="<?php echo url('content/specialservice'); ?>" method="post">
        ...
        <form class="form form-horizontal" action="<?php echo url('specialservice/companycontent_sort'); ?>" method="post">

            <div class="cl pd-5 bg-1 bk-gray mt-20">
		<span class="l">

			<a class="btn btn-primary radius" href="<?php echo url('specialservice/companycontent_edit','option=add'); ?>"><i class="Hui-iconfont">&#xe600;</i> 添加公司</a>
            ...
            <div class="mt-20">
                <table class="table table-border table-bordered table-bg table-hover table-sort">
                    ...
                    <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                        <tr class="text-c">
                            <td><input name="check" type="checkbox" value="<?php echo $vo['content_id']; ?>"></td>
                            <td>
                                <?php if(is_array($vo['picture_show']) || $vo['picture_show'] instanceof \think\Collection || $vo['picture_show'] instanceof \think\Paginator): $i = 0; $__LIST__ = $vo['picture_show'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$img): $mod = ($i % 2 );++$i;?>

                                    <div class="picbox"><a href="<?php echo $img; ?>" data-lightbox="gallery" data-title="<?php echo $vo['name']; ?>" style="float:left">
                                        <img width="50" class="picture-thumb" src="<?php echo $img; ?>" title="单击放大"></a></div>
                                <?php endforeach; endif; else: echo "" ;endif; ?>

                            </td>
                            <td><?php echo $vo['filter']['condition']; ?></td>
                            <td><?php echo $vo['name']; ?></td>
                            <td><?php echo $vo['found_time']; ?></td>
                            <td><?php echo $vo['aptitude']; ?></td>
                            <td><?php echo $vo['tally']; ?></td>
                            <td><?php echo $vo['solid_assets']; ?></td>
                            <td><?php echo $vo['regmoney']; ?></td>
                            <td><?php echo $vo['remark']; ?></td>
                            <td><?php echo $vo['price']; ?></td>
                            <td><?php echo $vo['create_time']; ?></td>
                            <td class="td-manage">

                                <a style="text-decoration:none" class="ml-5" href="<?php echo url('specialservice/companycontent_edit',['id'=>$vo['content_id'],'option'=>'update']); ?>" title="编辑"><i class="Hui-iconfont" style="font-size:20px;">&#xe6df;</i></a>
                                <a style="text-decoration:none" class="ml-5" onClick="picture_del(this,'<?php echo $vo['content_id']; ?>')" href="javascript:;" title="删除"><i class="Hui-iconfont" style="font-size:20px;">&#xe6e2;</i></a>
                            </td>
                            <input type="hidden" name="id_array[]" value="<?php echo $vo['content_id']; ?>"/>
                        </tr>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                    </tbody>
                </table>
    ...
    <script type="text/javascript">
        ...
        function picture_stop(obj,id,show){
            layer.confirm('确认要下架吗？',function(index){
                $.ajax({
                    type: 'POST',
                    url: "<?php echo url('specialservice/companycontent_show'); ?>",
        ...
        function picture_del(obj,id){
            layer.confirm('确认要删除吗？',function(index){
                $.ajax({
                    type: 'POST',
                    url: "<?php echo url('specialservice/companycontent_delete'); ?>",
                    data:{id:id},
                    dataType: 'json',
                    success: function(data){
                        if(data.msg == 'success') {
        ...
        function picture_batch_del(){
            layer.confirm('确认要批量删除吗？',function(index){
                ...
                $.ajax({
                    type: 'POST',
                    url: "<?php echo url('specialservice/companycontent_batch_delete'); ?>",
