<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:86:"/data/wwwroot/app.yikesong66.com/public/../application/useradmin/view/order/index.html";i:1536741710;s:76:"/data/wwwroot/app.yikesong66.com/application/useradmin/view/common/base.html";i:1536741707;s:76:"/data/wwwroot/app.yikesong66.com/application/useradmin/view/common/meta.html";i:1536741707;s:78:"/data/wwwroot/app.yikesong66.com/application/useradmin/view/common/footer.html";i:1536741707;}*/ ?>
<!--引入meta模板-->
<!DOCTYPE HTML>
<html>
<head>
    ...
    <div class="page-container">
        <div class="text-c">
            <form class="form form-horizontal" action="<?php echo url('order/index'); ?>" method="post">
                ...
                <select name="service_name" id="service_name" class="">
                ...
                <select name="assign" id="sta" class="">
                    <option value="">--请选择--</option>
            ...
            $.ajax({
                ...
                success:function(data){
                    switch(data.status){
                        case "success":
                            //alert('添加成功');
                            $(th).parent().find(".assign_text").val('待接单')//为什么没效果？
