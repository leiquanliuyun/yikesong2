<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:93:"/data/wwwroot/app.yikesong66.com/public/../application/useradmin/view/pact/pacttemp_edit.html";i:1536720771;s:76:"/data/wwwroot/app.yikesong66.com/application/useradmin/view/common/base.html";i:1536720770;s:76:"/data/wwwroot/app.yikesong66.com/application/useradmin/view/common/meta.html";i:1536720770;s:78:"/data/wwwroot/app.yikesong66.com/application/useradmin/view/common/footer.html";i:1536720770;}*/ ?>
<!--引入meta模板-->
<!DOCTYPE HTML>
<html>
<head>
...
<!--模板继承 业务内容-->
    ...
    <div class="page-container">
        <form class="form form-horizontal" id="form-article-add" action="<?php echo url('pact/pacttemp_edit'); ?>" method="post">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <?php if(is_array($options) || $options instanceof \think\Collection || $options instanceof \think\Paginator): $k = 0; $__LIST__ = $options;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$info): $mod = ($k % 2 );++$k;if(!(empty($list) || (($list instanceof \think\Collection || $list instanceof \think\Paginator ) && $list->isEmpty()))): if(array_search($info['option_id'],$list['options']) === false): ?>
                                <input type="checkbox" value="<?php echo $info['option_id']; ?>" name="options[]" ><?php echo $info['name']; else: ?>
                                <input type="checkbox" value="<?php echo $info['option_id']; ?>" name="options[]" checked="checked"><?php echo $info['name']; endif; endif; if(empty($list) || (($list instanceof \think\Collection || $list instanceof \think\Paginator ) && $list->isEmpty())): ?>
                            <input type="checkbox" value="<?php echo $info['option_id']; ?>" name="options[]" ><?php echo $info['name']; endif; endforeach; endif; else: echo "" ;endif; ?>
                </div>
            </div>
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    ...
                    <?php endif; ?>
                    <input type="button" class="btn btn-small" onclick="$('#thumb-preview').attr('src','/static/h-ui.images/default-thumbnail.png');$('#picture').val('');return false;" value="取消图片">
                </div>
            </div>
            <div class="row cl">
