<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:83:"D:\wamp\www\yikesong\public/../application/useradmin\view\pact\pactoption_edit.html";i:1536804058;s:64:"D:\wamp\www\yikesong\application\useradmin\view\common\base.html";i:1536804058;s:64:"D:\wamp\www\yikesong\application\useradmin\view\common\meta.html";i:1536804058;s:66:"D:\wamp\www\yikesong\application\useradmin\view\common\footer.html";i:1536804057;}*/ ?>
<!--引入meta模板-->
<!DOCTYPE HTML>
<html>
<head>
        ...
        <form class="form form-horizontal" id="form-article-add" action="<?php echo url('pact/pactoption_edit'); ?>" method="post">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    ...
                    <?php endif; ?>
                    <input type="button" class="btn btn-small" onclick="$('#thumb-preview').attr('src','/yikesong/public/static/h-ui.images/default-thumbnail.png');$('#icon').val('');return false;" value="取消图片">
                </div>
            </div>
            <div class="row cl">
