<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:79:"D:\wamp\www\yikesong\public/../application/useradmin\view\service\integral.html";i:1536804055;s:64:"D:\wamp\www\yikesong\application\useradmin\view\common\base.html";i:1536804058;s:64:"D:\wamp\www\yikesong\application\useradmin\view\common\meta.html";i:1536804058;s:66:"D:\wamp\www\yikesong\application\useradmin\view\common\footer.html";i:1536804057;}*/ ?>
<!--引入meta模板-->
<!DOCTYPE HTML>
<html>
<head>
...
<!--模板继承 业务内容-->
    ...
    <div class="page-container">
        ...
        <form class="form form-horizontal" action="<?php echo url('service/integral_sort'); ?>" method="post">

            <div class="cl pd-5 bg-1 bk-gray mt-20">
		<span class="l">
			<!--<a href="javascript:;" onclick="picture_batch_del()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a>-->
			<a class="btn btn-primary radius" href="<?php echo url('service/integral_edit','option=add'); ?>"><i class="Hui-iconfont">&#xe600;</i> 添加服务</a>
                    ...
                    <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                        <tr class="text-c">
                            ...
                            <td class="td-manage">
                                ...
                                <a style="text-decoration:none" class="ml-5" href="<?php echo url('service/integral_edit',['id'=>$vo['id'],'option'=>'update']); ?>" title="编辑"><i class="Hui-iconfont" style="font-size:20px;">&#xe6df;</i></a>
    ...
    <script type="text/javascript">
        ...
        function picture_stop(obj,id,show){
            layer.confirm('确认要下架吗？',function(index){
                $.ajax({
                    type: 'POST',
                    url: "<?php echo url('service/integral_show'); ?>",
        ...
        function picture_del(obj,id){
            layer.confirm('确认要删除吗？',function(index){
                $.ajax({
                    type: 'POST',
                    url: "<?php echo url('service/integral_delete'); ?>",
                    data:{id:id},
                    dataType: 'json',
                    success: function(data){
                        if(data.msg == 'success') {
        ...
        function picture_batch_del(){
            layer.confirm('确认要批量删除吗？',function(index){
                ...
                $.ajax({
                    type: 'POST',
                    url: "<?php echo url('service/integral_batch_delete'); ?>",
