<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:90:"D:\wamp\www\yikesong\public/../application/useradmin\view\service\servicecontent_edit.html";i:1542610643;s:64:"D:\wamp\www\yikesong\application\useradmin\view\common\base.html";i:1536804058;s:64:"D:\wamp\www\yikesong\application\useradmin\view\common\meta.html";i:1536804058;s:66:"D:\wamp\www\yikesong\application\useradmin\view\common\footer.html";i:1536804057;}*/ ?>
<!--引入meta模板-->
<!DOCTYPE HTML>
<html>
<head>
...
<!--模板继承 业务内容-->
    ...
    <div class="page-container">
        <form class="form form-horizontal" id="form-article-add" action="<?php echo url('service/servicecontent_edit'); ?>" method="post">
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2">所属服务：</label>
                <div class="formControls col-xs-8 col-sm-9">
                    <span class="select-box">
                    <select name="service" id="sname" class="select">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" value="<?php echo !empty($list['phone'])?$list['phone']: ''; ?>" placeholder="" id="" name="phone">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2">服务价格：</label>
                <div class="formControls col-xs-8 col-sm-9">
            ...
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2">服务轮播图：</label>
...
<script type="text/javascript">
        ...
        $(function(){
            var ser = "<?php echo $list['service']; ?>";
            $("#sname option[value="+ser+"]").attr("selected",true);
        });
        $(function(){
