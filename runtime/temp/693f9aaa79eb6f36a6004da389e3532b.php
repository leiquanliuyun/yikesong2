<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:84:"/data/wwwroot/app.yikesong66.com/public/../application/useradmin/view/pact/pact.html";i:1536741710;s:76:"/data/wwwroot/app.yikesong66.com/application/useradmin/view/common/base.html";i:1536741707;s:76:"/data/wwwroot/app.yikesong66.com/application/useradmin/view/common/meta.html";i:1536741707;s:78:"/data/wwwroot/app.yikesong66.com/application/useradmin/view/common/footer.html";i:1536741707;}*/ ?>
<!--引入meta模板-->
<!DOCTYPE HTML>
<html>
<head>
...
<!--模板继承 业务内容-->
    ...
    <div class="page-container">
        ...
        <form class="form form-horizontal" action="<?php echo url('pact/pact_sort'); ?>" method="post">

            <div class="cl pd-5 bg-1 bk-gray mt-20">
		<span class="l">
			<a href="javascript:;" onclick="picture_batch_del()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a>
			<!--<a class="btn btn-primary radius" href="<?php echo url('pact/pact_add',['order_id'=>81,'option'=>'add']); ?>"><i class="Hui-iconfont">&#xe600;</i> 添加合同</a>-->
                ...
                <table class="table table-border table-bordered table-bg table-hover table-sort">
                    ...
                    <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                        <tr class="text-c">
                            ...
                            <td><?php echo $vo['order']['ordernum']; ?></td>
                            <td><?php echo $vo['order']['status_text']; ?></td>
                            <td><?php echo $vo['order']['service_name']; ?></td>
                            <td><?php echo $vo['master']; ?></td>
                            <td><?php echo $vo['master_sign_time']; ?></td>
                            <td><?php echo $vo['facilitator']; ?></td>
                            <td><?php echo $vo['status_text']; ?></td>
                            <td><?php echo $vo['create_time']; ?></td>
                            <td class="td-manage">
                                <a style="text-decoration:none" class="ml-5" href="<?php echo url('pact/pact_edit',['order_id'=>$vo['order_id'],'option'=>'update']); ?>" title="编辑"><i class="Hui-iconfont" style="font-size:20px;">&#xe6df;</i></a>
    ...
    <script type="text/javascript">
        ...
        function picture_del(obj,id){
            layer.confirm('确认要删除吗？',function(index){
                $.ajax({
                    type: 'POST',
                    url: "<?php echo url('pact/pact_delete'); ?>",
                    data:{id:id},
                    dataType: 'json',
        ...
        function picture_batch_del(){
            layer.confirm('确认要批量删除吗？',function(index){
                ...
                if (check_value.length===0){
                    layer.msg('请先选择要删除的合同!',{icon:2,time:1000});
                }
                $.ajax({
                    type: 'POST',
                    url: "<?php echo url('pact/pact_batch_delete'); ?>",
