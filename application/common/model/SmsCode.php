...
class SmsCode extends Sms{
    ...
    const TIME_OUT = 180000000;    // 验证超时时间，单位秒
    // 验证码类型，1：注册
    ...
    public static function getTpl( $sms_type ){
        ...
        switch ($sms_type){
            ...
            case self::LOGIN_TYPE:
                ...
                break;
            case self::RESET_PASSWORD_TYPE:
                $tpl_code = self::CHANGE_PWD_VERIFY;
                break;
            case self::CHANGE_OLD_MOBILE:
    ...
    */
    public static function create( $mobile , $type , $user_type = null ){
        ...
        if( config('app_env') == 'dev'  || ($user_type == 2 && self::REGISTER_TYPE) ){
            ...
            $code = $res ? $res['code'] : randCode(6 , 1);
            // 调用发送短信系统
