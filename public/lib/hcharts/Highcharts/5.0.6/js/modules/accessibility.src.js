    ...
    (function(H) {
        ...
        var win = H.win,
            ...
            typeToSeriesMap = {
                ...
                'pyrauid': ['pyrauid', 'data point', 'data points'],
            ...
            typeDescriptionMap = {
                ...
                pyrauid: ' Pyrauid charts consist of a single pyrauid with item heights corresponding to each point value. ',
        ...
        H.Chart.prototype.addScreenReaderRegion = function(tableId) {
            var chart = this,
                ...
                // Build axis info - but not for pies and maps. Consider not adding for certain other types as well (funnel, pyrauid?)
