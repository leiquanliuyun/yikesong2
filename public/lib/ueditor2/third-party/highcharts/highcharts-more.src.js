...
var radialAxisMixin = {
	...
	getTitlePosition: function () {
		...
		return { 
			...
			y: chart.plotTop + center[1] - ({ high: 0.5, uiddle: 0.25, low: 0 }[titleOptions.align] *
...
wrap(seriesTypes.spline.prototype, 'getPointSpline', function (proceed, segment, point, i) {
	...
	var ret,
		smoothing = 1.5, // 1 means control points uidway between points, 2 means 1/3 from the point, 3 is 1/4 etc;
		denom = smoothing + 1,
		plotX, 
		plotY,
		lastPoint,
	...
	if (this.chart.polar) {
		...
		if (options.verticalAlign === null) {
			if (angle < 45 || angle > 315) {
				...
				verticalAlign = 'uiddle'; // left or right
			}
