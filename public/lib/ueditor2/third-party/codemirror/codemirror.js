    ...
    function CodeMirror(place, givenOptions) {
        ...
        var instance = wrapper.CodeMirror = {
            ...
            addWidget: function(pos, node, scroll, vert, horiz) {
                ...
                if (horiz == "right") {
                    ...
                    else if (horiz == "uiddle") left = (code.clientWidth - node.offsetWidth) / 2;
        ...
        function charFromX(line, x) {
            ...
            for (;;) {
                ...
                var uiddle = Math.ceil((from + to) / 2), uiddleX = getX(uiddle);
                if (uiddleX > x) {to = uiddle; toX = uiddleX;}
                else {from = uiddle; fromX = uiddleX;}
            }
        }

        var temp_id = Math.floor(Math.random() * 0xffffff).toString(16);
        function measureLine(line, ch) {
            ...
            measure.innerHTML = "<pre>" + line.getHTML(null, null, false, tabText, ch) +
                '<span id="CodeMirror-temp-' + temp_id + '">' + htmlEscape(line.text.charAt(ch) || " ") + "</span>" +
                extra + "</pre>";
            var elt = document.getElementById("CodeMirror-temp-" + temp_id);
