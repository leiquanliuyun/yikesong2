...
(function(){
	...
	function build() {
		...
		svg.AspectRatio = function(ctx, aspectRatio, width, desiredWidth, height, desiredHeight, minX, minY, refX, refY) {
			...
			var align = aspectRatio.split(' ')[0] || 'xuidYuid';
			...
			if (refX.hasValue() && refY.hasValue()) {				
				...
				// align
				if (align.match(/^xuid/) && ((meetOrSlice == 'meet' && scaleMin == scaleY) || (meetOrSlice == 'slice' && scaleMax == scaleY))) ctx.translate(width / 2.0 - desiredWidth / 2.0, 0);
				if (align.match(/Yuid$/) && ((meetOrSlice == 'meet' && scaleMin == scaleX) || (meetOrSlice == 'slice' && scaleMax == scaleX))) ctx.translate(0, height / 2.0 - desiredHeight / 2.0);
		...
		svg.Element.PathElementBase = function(node) {
			...
			this.renderChildren = function(ctx) {
				...
				if (markers != null) {
					...
					if (this.style('marker-uid').Definition.isUrl()) {
						var marker = this.style('marker-uid').Definition.getDefinition();
